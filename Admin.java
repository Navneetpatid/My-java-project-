...
public class EngagementService {
    ...
    public List<Map<String, Object>> validateWorkspaceForEngagement(String engagementId, String workspace) {
        ...
        try {
            ...
            response.put("mandatoryPlugins", mandatoryPlugins != null ? mandatoryPlugins : new ArrayList<>());
            ...
            response.put("success", "false");
            response.put("errors", "Internal Server Error: " + e.getMessage());
            response.put("logs", "Exception occurred while processing request");
            e.printStackTrace();  // Log this properly in real applications
        }
