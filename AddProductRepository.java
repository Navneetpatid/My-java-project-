...
pipeline {
    ...
    parameters {
        ...
        string(name: 'Nexus_Target_Image', defaultValue: 'gcr.io/project/app:1.0.0', description: 'Target image path in GCR')
    }
    ...
    stages {
        stage('Run Docker Image Promotion Pipeline') {
            steps {
                script {
                    // Call your Groovy script with Jenkins parameters
                    testPipeline([
